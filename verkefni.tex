...
\begin{theorem}[The Riesz reprentation theorem for bounded linear functionals on $C_0(X)$ with locally compact $X$ \citep{rudin2}]
\label{riesz}
...
Let $X$ be a compact Hausdorff space,
	...
	and $\Xi > 0$ be a function on $X$ such that $|f| < \Xi$ on $S$.
