...
It can be useful to think of $P_r(t)$ as a function of two variables $r$ and $t$, since it allows us to rewrite $P_r(\theta - t)$, by setting $z = re^{it}$, as
\[
...
\]
A benefit of this rewrite is that $P(\ \cdot\ , e^{it})$ is defined on $\mathbb{D}$.
