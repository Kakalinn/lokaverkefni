...
% COMMENT(gardar): Since K is compact, f is uniformally continuous
...
\end{proof}
% COMMENT(gardar): Eru ]0,1] og T grannmóta? Ég skil f(t) = e^it2pi virkar í aðra áttina, en er til samfelld andhverfa?
...
\begin{align*}
    ...
    % COMMENT(gardar): vantar opna sviga í seinasta log.
...
Let $X$ be a compact Hausdorff space,
    ...
    % COMMENT(gardar): $\Xi: X \to \mathbb{R}, \Xi > 0$ ...
