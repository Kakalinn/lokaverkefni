...
\begin{definition}
A function is said to be in the \emph{disk algebra} if it is holomorphic on $\mathbb{D}$ and continuous on $\mathbb{\overline{D}}$.
...
% TODO laga þýðinguna á two-cell
...
This borrows from \citep{bishop}. % TODO add citation
