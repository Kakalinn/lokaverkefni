...
To prove one of the lemmas we will also use the following famous theorem:
\begin{definition}
% TODO finish these
Pointwise bounded and equicontinuity.
\end{definition}
\begin{theorem}[Arzela-Ascoli] %TODO prove this or move it to preliminaries
...
Let $X$ be a separable Banach space,
	$\{ \Gamma_n\}$ be a sequence of linear functionals on $X$,
	and $\sup_n \|\Gamma_n\| = M < \infty$.
Then there exists a subsequence $\{\Gamma_{n_i}\}$ such that the limit 
\[
	\Gamma x = \lim_{i \rightarrow \infty} \Gamma_{n_i} x
\]
