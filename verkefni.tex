...
\]
and show they fulfill the following properties:
\begin{enumerate}
\item
...
&\leq \int g_H\ d\sigma\\
&= \int \lim_{n \rightarrow \infty} g_n\ d\sigma\\
&= \lim_{n \rightarrow \infty} g_n\ d\sigma\\
&= \lim_{n \rightarrow \infty} \sum_{k = 1}^n k2^{-k}\\
&= \sum_{k \in \mathbb{N}} k2^{-k}\\
&< \infty
\end{align*}
...
Note that we left some fundementals unmentioned.
Specifically the fact that $f_H$ and $g_H$ are measureable.
To show that $g$ is measureable it suffices to show that $(g_n)_{n \in \mathbb{N}}$ are measureable.
We, therefore, can show that the preimage under $g_n$ of each point is measureble, since $g_n$ is simple, for each $n$.
